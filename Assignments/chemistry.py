...
def main():
  ...
  mass = float(input("Please enter the mass in grams of the sample: "))
  ...
  atomic_number_total = sum_protons(symbol_quantity, periodic_table_dict)
  atomic_number_total = math.ceil(atomic_number_total)
  
  # Print the Results ----------------------------------------------------------------
  print(f"The name of the formula is {name}")
  print(f"The Total of protons in the formula is {atomic_number_total}")
...
def sum_protons(symbol_quantity_list, periodic_table_dict):
  ...
  for element in symbol_quantity_list:
    ...
    atomic_number_sum = atomic_number * quantity
    protons += atomic_number_sum
  return protons    
