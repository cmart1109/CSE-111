...
from water_flow import water_column_height, pressure_gain_from_water_height, pressure_loss_from_pipe, pressure_loss_from_fittings, reynolds_number, pressure_loss_from_pipe_reduction, pounds_per_square_inch
import pytest
...
def test_pressure_gain_from_water_height():
    assert pressure_gain_from_water_height(0.0) == approx(0.0, abs=0.0)
...
def test_pounds_per_square_inch():
    assert pounds_per_square_inch(0) == approx(0, abs=0.001)
    assert pounds_per_square_inch(173.25) == approx(25.127, abs=0.001)
